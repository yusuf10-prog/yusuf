...
public class C04_FibonacciSayisi {
    public static void main(String[] args) {
        ...
        System.out.println(fibonacciListesi(26));
    }

    public  static List<Integer> fibonacciListesi(int fibonacciSayiAdedi){
        ...
        if (fibonacciSayiAdedi<=0){
            System.out.println("Beyfendi giciklik yapmayiniz");
