...
public class C01_TekrarEdenSayilariSilme {
    public static void main(String[] args) {
        ...
        // array'i uniqe degerlerden olusan haline donusturun

        int arr[]={2,4,5,2,5,1,5,3,7};

        // [2,4,5,3,1,7]

        /*
        Array'in en buyuk problemi uzunluğunun degisememesidir.
        ...
        // ele aldigimiz element listede yoksa listeye ekleyebilirsiniz.
        ...
        System.out.println(tekrarsizList); //[2, 4, 5, 1, 3, 7]

        // array'i uniqe degerlerden olusan haline donusturun

        System.out.println(Arrays.toString(arr)); //[2, 4, 5, 2, 5, 1, 5, 3, 7]
        ...
        for (int i = 0; i < arr.length ; i++) {
            ...
            System.out.println(Arrays.toString(arr)); //[2, 4, 5, 1, 3, 7]
