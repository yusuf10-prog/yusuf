...
public class C01_ArrayOlusturma {
    public static void main(String[] args) {
        ...
        String [] sinifListesi={null, null,null, null,null};
        ...
        2- Array'in uzunlugu(Bir array'e olusturulurken yazilan uzunlugundan
                                daha fazla element konulmaz)
         */

        // bir array'in tumunu nasıl yazdirabiliriz?
        ...
        System.out.println(Arrays.toString(sinifListesi));  //[null, null, null, null, null]
