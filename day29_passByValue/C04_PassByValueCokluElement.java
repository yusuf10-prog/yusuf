...
public class C04_PassByValueCokluElement {
    public static void main(String[] args) {
        ...
        /*
            ...
            pass by value method'lar arasinda variable'in kendisinin degil
            value'sunun gecisini saglamak anlamina gelir.

            pass by value 'de hata yapmak icin dikkat etmemiz gereken durum
            method'lar arasinda yollanan argument veya return degerinin
            tek bir element mi yoksa coklu element iceren bir java yapisi mi oldugudur.

           - eger tek bir element ise
           gittigi method'da yapilan degisiklik KALİCİ OLMAZ
        ...
        System.out.println("Main method'da call'dan onca arr :" + Arrays.toString(arr));
        ...
        System.out.println("Main method'da call'dan onca arr :" + Arrays.toString(arr2));
        elementEkle(arr2);
    ...
    public static void elementEkle(int [] arr2){
       int [] yeniArr=new int[arr2.length+1]; // [0, 0, 0, 0]
        ...
        System.out.println("Medhod'da arr2'nin yeni hali : " + Arrays.toString(arr2) );
    }
