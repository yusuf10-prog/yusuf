...
public class C01_IndexOf {
    public static void main(String[] args) {
        ...
        // ilk top metin parcasında index'ini yazdirin.

        System.out.println(str.indexOf("top"));  // 4

        // ikinci top metin parcasininin index'ini yazdirin

        System.out.println(str.indexOf("top", 5)); // 13

        System.out.println(str.indexOf("top", str.indexOf("top")+1));

        // at kelimesinin 2 kere kullanilip kullanılmadığının metne bakmadan bulun

        int ilkIndex=str.indexOf("at");  // ya -1 veya dogal sayi olur

        if (ilkIndex ==-1){  // hiç kullanılmamiş

            System.out.println("2 kere kullanilmamis");

        }else { // en az 1 kere kullanilmamiş

            int ikinciIndex=str.indexOf("at", ilkIndex+1);
            // -1 veya 2.defa kullanilmişsa dogal sayi olur.
