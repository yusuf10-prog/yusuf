...
public class C02_lastIndexOF {
    public static void main(String[] args) {
        ...
        if (ilkIndex==-1){
            System.out.println("Hic e kullanilmamiş");
        }else if (ilkIndex == sonIndex){
            System.out.println("Sadece 1 kere kullanilmiş");
        }else {
            System.out.println("e harfi 2 kere veya daha fazla kullanilmiş");
        }

        // "Javayi ogreneceğiz, başka yolu yok,

        // o harfinin son index'ini yazdirin

        System.out.println(str.lastIndexOf("o"));  // 32

        // o harfinin son kullanimından bir onceki kullaniminin index'ini yazdirin
