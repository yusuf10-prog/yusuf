...
public class C03_AndOperatoru {
    public static void main(String[] args) {
        ...
        System.out.println(5 > 3 && 6 <= 4);  // true and fales ==> false

        System.out.println(5 <= 3 && 6 <= 4);  // false and false == > false

        /* && operatoru mukemmeliyicetçidir.

        && operatoru ile baglanan boolean ifadeler kaç tane olursa olsun
         hepsi true ise sonuc true;
         bunun disindaki tum durumlarda false

         bu yonuyle matematikteki çarmaya benzer
