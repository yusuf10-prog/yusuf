...
public class C06_equals {
    public static void main(String[] args) {
        ...
        /*
            ...
            String'lerde  == bekledigimiz sonuculari DONMEYEBILIR
            Bunun sebebi String class'ini olustururken yapilan bazi ozelliklerdir
            bu konu ilerde detaylı bir sekilde anlatilacak
            ...
            bu karsilastirmada metnin ayni olması yaninda,
            buyuk kucuk harf durumunu da kontrol eder (case sensitive)

            EGER case sensitive olmadan metinleri karsilistirmak isterseniz
            equalsIgnoreCase()'u kullanilir.

         */

        System.out.println(str1.equals(str2));  // Mehmet -- MEHMET karsilastirması yapıyor.
