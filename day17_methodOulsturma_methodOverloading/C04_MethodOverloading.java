...
public class C04_MethodOverloading {
    public static void main(String[] args) {
        ...
        sonra argument olarak verilen değerler ile,
        parametre olarak yazilan variable'larin data turlerini karsilastirir
        ve uyumlu ise method'u calistirir
        argumentler ile parametreler uyumlu degilse CTE verir. (compile time error)

        Java'da aynı data turune ve parametre sayisina sahip
        birden fazla method olusturamazsınız
